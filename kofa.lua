-- KofaHVH v4.1 - Fixed AntiKick Lag
...
local tabs = {}
local tabNames = {"Teleport", "AutoTP", "Noclip", "Speed", "AntiKick", "ESP", "Settings"}
...
local keyBindings = {}
local availableKeys = {"Delete", "R", "T", "N", "K", "G", "F", "H", "PageUp", "PageDown", "F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9", "F10", "F11", "F12", "Q", "E", "V", "B", "C", "X", "Z", "Space", "LeftControl", "RightControl", "LeftShift", "RightShift", "1", "2", "3", "4", "5"}
...
sizeFrame.Position = UDim2.new(0.05, 0, 0, 550)
...
saveBtn.Position = UDim2.new(0.05, 0, 0, 640)
...
saveBtn.MouseButton1Click:Connect(function()
    ...
    confirm.Position = UDim2.new(0.05, 0, 0, 700)
...
print("========================================")
print("🔥 KofaHVH v4.1 LOADED 🔥")
print("Fixed AntiKick Lag + All Features Working")
print("========================================")
print("Features:")
